  ...
  return (
    <div className="w-full h-fit border border-gray-200 shadow-lg shadow-gray-300/40 rounded-3xl">
      ...
      <div className="relative -top-8 w-full px-14 pb-6">
        {
          isActive ? (
            <div className="flex flex-row gap-4 items-center justify-between px-1.5 py-0.5 rounded-2xl bg-yellow-400">
              ...
              <button className="px-4 py-4 text-sm bg-gray-800 text-white rounded-xl">Download</button>
            </div>
          ) : (
            <div className="flex flex-row gap-4 items-center justify-between px-1.5 py-0.5 rounded-2xl bg-blue-100">
              <div className="px-4 py-4">
              ...
              <button className="px-4 py-4 text-sm bg-gray-800 text-white rounded-xl">Booking</button>
            </div>
          )
        }
